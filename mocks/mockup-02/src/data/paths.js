...
export const RESULTS = {
  ...
  urgent: {
    ...
    highlight: 'Procure um serviço de urgência/emergência agora.',
    body: 'Identificamos informações que merecem avaliação presencial rápida. Pelas respostas fornecidas, não recomendamos aguardar uma consulta eletiva ou contato da nossa equipe.',
  },
  unclear: {
    kind: 'indeterminate',
