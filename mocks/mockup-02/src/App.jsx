...
export default function App() {
  ...
  useEffect(() => {
    ...
    const sync = () => {
      setNarrowFooter(mq.matches)
      setFooterOpen(!mq.matches)
    }
    sync()
  ...
  return (
    <div className={`app-shell${step === 'landing' ? ' is-landing' : ''}`}>
      ...
      <footer className="site-footer">
        <div className="site-footer__inner">
          <details
            className="site-footer__fold"
            open={!narrowFooter || footerOpen}
            onToggle={(e) => {
              if (narrowFooter) setFooterOpen(e.currentTarget.open)
            }}
          >
            <summary className="site-footer__title">Informações sobre dados</summary>
            <div className="site-footer__body">
              <p className="site-footer__policy">
                Nós não armazenamos nenhum dado durante a sua procura, e os seus dados são
                anonimizados antes da utilização de LLMs. Dados pessoais como nome e telefone podem
                ser requisitados apenas após a sua procura, caso você queira nossa ajuda para
                encontrar um bom médico para você.
              </p>
              <p className="site-footer__policy">
